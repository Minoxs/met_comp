...
\usepackage{fancyhdr}
\fancypagestyle{title} %Estou colocando meu nome no cabeçalho da primeira página, junto à créditos ao autor original
{
\fancyhf{}
\renewcommand{\headrulewidth}{0.5pt}
\lhead{\small{
	FIS01203 - Métodos Computacionais Da Física \\
	Guilherme Wagner Correa\\
	Instituto de Física, UFRGS
}}
\rhead{\small{
	Artigo original pode ser encontrado em:\\ \url{http://dx.doi.org/10.1590/1806-9126-RBEF-2018-0243} \\
	Reprodução do artigo de A.V Andrade-Neto, para fins educacionais.
}}
} 
\fancypagestyle{creditos} %Nas demais páginas somente créditos ao autor original no cabeçalho
{
\fancyhf{}
\renewcommand{\headrulewidth}{0.5pt}
\chead{\small{
	Artigo original pode ser encontrado em: \url{http://dx.doi.org/10.1590/1806-9126-RBEF-2018-0243} \\
	Reprodução (usando \LaTeX) do artigo de A.V Andrade-Neto, para fins educacionais.
}}
}
%%%%%%%%%%%%

\setlength{\bibsep}{0.0pt}
\geometry{verbose,tmargin=2.57cm,bmargin=2.57cm,lmargin=1.6cm,rmargin=1.9cm}
...
\end{abstract}
\begin{multicols}{2} %Estarei usando o espaço multicols até a ante-penúltima página. Pois, o comando \twocolumn separa o título do resto do texto.
...
\end{multicols} %Aqui eu faço uma troca do espaço multicols por \twocolumn
\twocolumn		%O motivo é que o espaço multicols mantém as duas colunas no mesmo tamanho, enquanto o \twocolumn permite que fiquem assimétricas.
...
\\
$$\int{F(r)\delta(r-r_{o})d\Omega}=F(r_{o})\;.$$ %remove label from this equation.
